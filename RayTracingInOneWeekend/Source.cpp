...
// Detection between a ray and a basic sphere
...
{
	// If we see the sphere turn that area red
...
int main()
{
	...
	// Calcualting the image height, making sure it's a least 1
	...
	{
		std::clog << "\rScanlines completed: " << j << ' ' << std::flush;
